            ...
            <!-- content for sidebar -->
             <div class="h-100">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="?page=employees" class="sidebar-link">
                            <i class="fa-solid fa-users icon"></i>
                            <span class="link-text">Manage Employees</span>
                        </a>
                    </li>
                </ul>
             </div>
                                        ...
                                        <div class="card flex-fill border-0 illustration">
                                            <div class="card-body p-0 d-flex flex-fill">
                                                <div class="row g-0 w-100">
                                                    <div class="col-6">
                                                        <div class="p-3 m-1">
                                                            <h4>Welcome Back, <span class="fw-bold text-primary">Marko!</span></h4>
                                        ...
                                        <div class="card flex-fill border-0 illustration">
                                            <div class="card-body p-0 d-flex flex-fill">
                                                <div class="row g-0 w-100">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="p-3 m-1">
                                                            <h4>Stay <span class="fw-bold text-primary">Organized</span>, Marko!</h4>
                                                            <p class="mb-0">Access your tools and manage your tasks effectively.</p>
                                                            <a href="?page=employees" class="btn btn-primary btn-bg mt-2">Manage Employees Now</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
